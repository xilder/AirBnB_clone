...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        h = ("\nUsage: quit\n"
                + "This command allows you to exit the interpreter "
                + "cleanly")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_create(self):
        h = ("\nUsage: create <model_class>"
                + "This command creates an instance of the specified"
                + "class and assigns it a unique identifier"
                + "Finally, it prints the instance's id")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_EOF(self):
        h = ("\nUsage: EOF\n"
                + "This command allows you to exit the  interpreter "
                + "cleanly by pressing the Ctrl Key + D key")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        h = ("\nUsage: show <model_class> <model_id>"
                + "This command displays the string representation "
                + "of an instance if the id provided exists")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_destroy(self):
        h = ("\nUsage: destroy <model_class> <model_id>"
                + "This command deletes an instance based on the"
                + "class name and id if they exist in the storage")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        h = ("\nUsage 1: all"
                + "This prints all instances in storage"
                + "\nUsage 2: all <model_class>"
                + "This prints all instances of the provided"
                + "<model_class>")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        h = ("\nUsage 1: count"
                + "This prints the numbe of  instances in storage"
                + "\nUsage 2: count <model_class>"
                + "This prints the number of instance of the provided "
                + "<model_class>")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = ("\nUsage: update <model_class> "
                + "<model_id> <attribute> <value>"
                + "This command updates an instance's "
